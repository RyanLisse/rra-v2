...
export const chat = pgTable('Chat', {
  ...
  userVisibilityIdx: index('chat_user_visibility_idx').on(table.userId, table.visibility),
}));
...
export const ragDocument = pgTable('RAGDocument', {
  ...
  userStatusIdx: index('rag_document_user_status_idx').on(table.uploadedBy, table.status),
...
export const documentContent = pgTable('DocumentContent', {
  ...
  documentIdIdx: uniqueIndex('document_content_document_id_idx').on(table.documentId),
}));
...
export const documentChunk = pgTable('DocumentChunk', {
  ...
  docChunkIdx: index('document_chunk_doc_chunk_idx').on(table.documentId, table.chunkIndex),
}));
...
export const documentEmbedding = pgTable('DocumentEmbedding', {
  ...
  chunkIdIdx: uniqueIndex('document_embedding_chunk_id_idx').on(table.chunkId),
