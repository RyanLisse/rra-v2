...
interface EnhancedSearchProps {
  ...
  savedSearches?: Array<{ id: string; name: string; query: string; filters: SearchFilters }>;
          ...
          >
            ...
            {hasActiveFilters && (
              <Badge variant="secondary" className="ml-1 h-4 text-xs">
                {filters.documentTypes.length + filters.tags.length + (filters.dateRange !== 'all' ? 1 : 0)}
              </Badge>
            )}
          </Button>
            ...
            <Card className="p-2 shadow-lg border">
              ...
              {mockSuggestions.map((suggestion) => (
                <button
                  ...
                  className="w-full px-2 py-2 text-left hover:bg-muted rounded text-sm flex items-center gap-2"
                  onClick={() => {
                    if (suggestion.type === 'query' || suggestion.type === 'history') {
                      ...
                      <Button variant="outline" className="w-full justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          {filters.dateRange === 'all' ? 'All time' : 
                           ...
                           filters.dateRange === 'month' ? 'This month' : 'Custom'}
                        </div>
                    ...
                    <DropdownMenuTrigger asChild>
                      <Button variant="outline" className="w-full justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          {filters.documentTypes.length === 0 ? 'All types' : 
                ...
                <div>
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent>
                      ...
                      <DropdownMenuSeparator />
                      {['calibration', 'installation', 'troubleshooting', 'maintenance'].map((tag) => (
                        <DropdownMenuCheckboxItem
                          key={tag}
