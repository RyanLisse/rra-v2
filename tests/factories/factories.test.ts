...
describe('Factory Tests', () => {
  ...
  describe('RAGDocumentFactory', () => {
    it('should create a valid RAG document', () => {
      ...
      expect(document.status).toMatch(/^(uploaded|processing|text_extracted|images_extracted|ade_processing|ade_processed|chunked|embedded|processed|error|error_image_extraction|error_ade_processing|failed)$/);
  ...
  describe('DocumentChunkFactory', () => {
    ...
    it('should create chunks for a document', () => {
      ...
      const chunks = documentChunkFactory.createChunksForDocument(documentId, chunkCount);
  ...
  describe('CompleteRAGDocumentFactory', () => {
    it('should create a complete RAG document with all relations', () => {
      ...
      completeDoc.embeddings.forEach(embedding => {
        ...
        expect(completeDoc.chunks.some(chunk => chunk.id === embedding.chunkId)).toBe(true);
      });
    });
